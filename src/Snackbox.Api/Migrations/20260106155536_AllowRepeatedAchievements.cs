        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 40, 8, "SPEED_DEMON", "Made 2 purchases within 1 minute", null, "Speed Demon" },
                    { 41, 8, "DOUBLE_TROUBLE", "Made exactly 2 purchases in a session", null, "Double Trouble" },
                    { 42, 8, "TRIPLE_THREAT", "Made exactly 3 purchases in a session", null, "Triple Threat" },
                    { 43, 8, "LUCKY_SEVEN", "Made exactly 7 purchases in a session", null, "Lucky Seven" },
