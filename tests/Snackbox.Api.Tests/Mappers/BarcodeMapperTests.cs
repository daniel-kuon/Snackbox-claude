...
public class BarcodeMapperTests
{
    ...
    public void ToDtoListWithUser_Barcodes_MapsAllItemsWithUsernames()
    {
        ...
        {
            new Barcode { Id = 1, UserId = 1, Code = "BC1", Amount = 1m, CreatedAt = DateTime.UtcNow, User = user1 },
            new Barcode { Id = 2, UserId = 2, Code = "BC2", Amount = 2m, CreatedAt = DateTime.UtcNow, User = user2 }
        };
